...
// It sets a new name, UUID, disk path, and MAC address.
func modifyClonedXMLHelper(sourceXML, newName, newDiskPath string, cpu, memoryMB int, network string) (string, error) {
